...
sy trust [COURSE]       # allow an attached course's rubric scripts
```
...
you consent (`sy trust <course>`, or `attach --trust`). Courses you
...
root; explicit single-course commands (`sy grade DIR MID`, the
