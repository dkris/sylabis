...
Given the compilation spec, one milestone, and its sources, write the lesson.
Structure: Title, time estimate, artifact statement, Context (why now),
Learn from (sources with what-you-need annotations), Do (numbered concrete
steps), Artifact spec (checkable requirements), Reflection prompt
(target the named misconception), What the grader checks.
